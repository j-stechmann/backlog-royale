...
### Documentation
- Added [ADR 0013](docs/adr/0013-hash-based-legal-pages.md) (hash-based legal pages, no router) and the Frontend architecture section on legal-page routing; documented the new components/hooks in the frontend file map, added the "Legal pages" feature to Features, noted self-hosters' legal-content responsibility in the self-hosting guide, and updated both READMEs.
